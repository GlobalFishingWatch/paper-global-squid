#standardsql
------------------------------------------------------------
-- Query to get the voyages for carriers that have positions in
-- the squid regions. Not all of these carriers will actually interact
-- with the squid fleet given the overlap with the longline fleets.
--
-- This is saved in
-- paper_global_squid.carrier_vessel_port_visits_withaoi_2017_2020_v20220525
------------------------------------------------------------
...
--
--Note: using proto table with confidence >=2
------------------------------------------------------------
  trip_ids AS (
    SELECT *
      FROM (
...
------------------------------------------------------------
-- Carrier vessels with positions in squid AOIs
------------------------------------------------------------
  ...
  carrier_ssvid AS (
    ...
    aoi
    FROM
    `world-fishing-827.paper_global_squid.carrier_positions_in_squidregions_v20220525`)
------------------------------------------------------------
-- Pull final ccrrier voyage
------------------------------------------------------------
SELECT
ssvid,
gfw_trip_id,
